    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-50 via-blue-100/20 to-indigo-100/30 dark:from-slate-950 dark:via-slate-900 dark:to-slate-800 font-sans text-foreground">
      <main className="flex w-full max-w-5xl flex-col gap-12 px-6 py-16 sm:px-12">
        <div className="flex flex-col items-center gap-6 text-center">
          ...
          <div className="h-px w-32 bg-gradient-to-r from-transparent via-blue-400 dark:via-blue-500 to-transparent"></div>
        </div>

        <div className="relative overflow-hidden rounded-3xl border-2 border-blue-200 dark:border-slate-700 bg-white dark:bg-slate-800/90 p-10 shadow-2xl">
          <div className="absolute right-0 top-0 h-64 w-64 -translate-y-12 translate-x-12 rounded-full bg-blue-500/5 dark:bg-blue-400/10 blur-3xl"></div>
          <div className="absolute bottom-0 left-0 h-64 w-64 translate-y-12 -translate-x-12 rounded-full bg-indigo-500/5 dark:bg-indigo-400/10 blur-3xl"></div>
          ...
          <div className="relative flex flex-col gap-6">
            <div className="flex flex-col gap-4">
              ...
              <p className="max-w-2xl text-xl leading-relaxed text-blue-700 dark:text-slate-300">
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              <div className="flex items-start gap-3 rounded-xl border border-blue-200 dark:border-slate-600 bg-blue-50/50 dark:bg-slate-700/50 p-4">
            ...
            <div className="flex flex-col items-start gap-4 sm:flex-row sm:items-center">
              <a
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-blue-600 px-8 py-4 text-base font-bold text-white shadow-lg shadow-blue-600/30 dark:shadow-none transition hover:bg-blue-700 hover:shadow-xl hover:shadow-blue-600/40"
                href="/register"
              >
